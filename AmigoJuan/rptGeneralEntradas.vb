...
Public Class rptGeneralEntradas
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "AmigoJuan.rptGeneralEntradas.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedrptGeneralEntradas
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rptGeneralEntradas = New rptGeneralEntradas()
        rpt.Site = Me.Site
        Return rpt
    End Function
