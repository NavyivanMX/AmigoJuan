...
Public Class rptSalidaDiversa
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "AmigoJuan.rptSalidaDiversa.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedrptSalidaDiversa
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rptSalidaDiversa = New rptSalidaDiversa()
        rpt.Site = Me.Site
        Return rpt
    End Function
