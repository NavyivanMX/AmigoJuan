...
Public Class rptKardexProducto
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "AmigoJuan.rptKardexProducto.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedrptKardexProducto
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rptKardexProducto = New rptKardexProducto()
        rpt.Site = Me.Site
        Return rpt
    End Function
