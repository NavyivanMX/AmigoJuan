Public Class frmEspecies
    ...
    Private Sub CARGASIGGPO()
        ...
        Dim NUM As Integer
        NUM = 1
        Dim SQLMOV As New SqlClient.SqlCommand("SELECT DBO.SIGESPECIES()", frmPrincipal.CONX)
    ...
    Private Sub CARGADATOS()
        ...
        End If
        ACTIVAR(False)
        Dim SQLSELECT As New SqlClient.SqlCommand("SELECT CLAVE,NOMBRE,ACTIVO,FAMILIA FROM ESPECIES WHERE CLAVE=" + TXTCLA.Text + "", frmPrincipal.CONX)
        Dim LECTOR As SqlClient.SqlDataReader
    ...
    Private Sub BTNGUARDAR_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles BTNGUARDAR.Click
        ...
        SQLGUARDAR.CommandText = "SPESPECIES"
    ...
    Private Sub BTNELIMINAR_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles BTNELIMINAR.Click
        ...
        If xyz = 6 Then
            Try
                ...
                SQLELIMINAR.CommandText = "DELETE FROM ESPECIES WHERE CLAVE=" + TXTCLA.Text
    ...
    Private Sub BTNBUSCAR_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles BTNBUSCAR.Click
        frmClsBusqueda.BUSCAR("SELECT CLAVE,NOMBRE,ACTIVO FROM ESPECIES", " WHERE NOMBRE", " ORDER BY NOMBRE", "Búsqueda de Especies", "Nombre de la especie", "Especie(s)", 1, frmPrincipal.CadenaConexion, True)
    ...
    Private Sub frmGrupos_KeyDown(ByVal sender As System.Object, ByVal e As System.Windows.Forms.KeyEventArgs) Handles MyBase.KeyDown
        ...
        If e.KeyCode = Keys.Alt + Keys.B Then
            frmClsBusqueda.BUSCAR("SELECT CLAVE,NOMBRE,ACTIVO FROM ESPECIES ", " WHERE NOMBRE", " ORDER BY NOMBRE", "Búsqueda de Especies", "Nombre de la Especies", "Especie(s)", 1, frmPrincipal.CadenaConexion, True)
            If frmClsBusqueda.DialogResult = Windows.Forms.DialogResult.Yes Then
                TXTCLA.Text = frmClsBusqueda.TREG.Rows(0).Item(0).ToString
                CARGADATOS()
            End If
