Public Class frmOrdenProductos
    Dim LCLA As New List(Of String)
    Private Sub frmOrdenProductos_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
    ...
    Private Sub CARGAR()
        ...
        LCLA.Clear()
        Dim QUERY As String
        QUERY = "SELECT CLAVE,NOMBRE FROM PRODUCTOS WHERE ACTIVO=1 ORDER BY ORDEN,NOMBRE"
