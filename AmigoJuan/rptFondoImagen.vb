...
Public Class rptFondoImagen
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "AmigoJuan.rptFondoImagen.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedrptFondoImagen
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rptFondoImagen = New rptFondoImagen()
        rpt.Site = Me.Site
        Return rpt
    End Function
