...
Public Class rptAlmacenCedis
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "AmigoJuan.rptAlmacenCedis.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedrptAlmacenCedis
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rptAlmacenCedis = New rptAlmacenCedis()
        rpt.Site = Me.Site
        Return rpt
    End Function
