Public Class frmEquivalenciasProductos
    ...
    Private Sub CARGADATOS()
        ...
        SQLSELECT.CommandText = "SELECT G.NOMBRE,P.NOMBRE,E.CANTIDAD,U.NOMBRE,E.CANTIDAD2,L.NOMBRE  FROM EQUIVALENCIAPRODUCTO E INNER JOIN PRODUCTOS P  ON P.CLAVE=E.PRODUCTO  INNER JOIN FAMILIASPRO G  ON G.CLAVE=p.FAMILIA  INNER JOIN UNIDADES U ON E.UNIDAD=U.CLAVE INNER JOIN LASUNIDADES L  ON E.UNIDAD2=L.CLAVE WHERE  E.PRODUCTO='" + CLAPROD(CBPROD.SelectedIndex) + "'"
