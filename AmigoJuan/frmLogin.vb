Public Class frmLogin
    ...
    Private Sub VALIDAR()
        Dim QUER As String
        QUER = "SELECT EMPRESA='Amigo Juan',U.NIVEL, NOMBREFISCAL='Juan Ahumada Acosta',CIUDAD='Los Mochis, Sinaloa',NOMBRECOMUN='Comercializadora de Mariscos Amigo Juan',U.NOMBRE,U.PERFIL,U.ACTIVO  FROM USUARIOS U WHERE U.USUARIO='" + TXTUSER.Text + "' AND U.PASSWORD='" + TXTPWD.Text + "'"
