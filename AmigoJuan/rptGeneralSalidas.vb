...
Public Class rptGeneralSalidas
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "AmigoJuan.rptGeneralSalidas.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedrptGeneralSalidas
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rptGeneralSalidas = New rptGeneralSalidas()
        rpt.Site = Me.Site
        Return rpt
    End Function
