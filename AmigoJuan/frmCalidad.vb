Public Class frmCalidad
    ...
    Private Sub frmCalidad_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
    ...
    Private Sub CARGASIGGPO()
        ...
        Dim NUM As Integer
        NUM = 1
        Dim SQLMOV As New SqlClient.SqlCommand("SELECT DBO.SIGCALIDAD()", frmPrincipal.CONX)
    ...
    Private Sub CARGADATOS()
        ...
        End If
        ACTIVAR(False)
        Dim SQLSELECT As New SqlClient.SqlCommand("SELECT CLAVE,NOMBRE,ACTIVO,FAMILIA FROM CALIDAD WHERE CLAVE=" + TXTCLA.Text + "", frmPrincipal.CONX)
        Dim LECTOR As SqlClient.SqlDataReader
    ...
    Private Sub BTNGUARDAR_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles BTNGUARDAR.Click
        ...
        SQLGUARDAR.CommandText = "SPCALIDAD"
    ...
    Private Sub BTNELIMINAR_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles BTNELIMINAR.Click
        ...
        If xyz = 6 Then
            Try
                ...
                SQLELIMINAR.CommandText = "DELETE FROM CALIDAD WHERE CLAVE=" + TXTCLA.Text
    ...
    Private Sub BTNBUSCAR_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles BTNBUSCAR.Click
        frmClsBusqueda.BUSCAR("SELECT CLAVE,NOMBRE,ACTIVO FROM CALIDAD", " WHERE NOMBRE", " ORDER BY NOMBRE", "Búsqueda de Calidades", "Nombre de la calidad", "Calidad(es) ", 1, frmPrincipal.CadenaConexion, True)
