...
Public Class rptEntradaDiversa
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "AmigoJuan.rptEntradaDiversa.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedrptEntradaDiversa
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rptEntradaDiversa = New rptEntradaDiversa()
        rpt.Site = Me.Site
        Return rpt
    End Function
